...
### 🔧 **動的プロンプト合成**
- **コンテキスト対応**：関連するすべてのコンテキストレイヤーを自動統合
- **目的駆動**：元の目標を見失うことがない
- **制約準拠**：蓄積された制約を一貫して適用
...
- **🎓 [チュートリアルシリーズ](docs/tutorials/)** - ステップバイステップガイド（近日公開）
...
**[始める](#-クイックスタート)** | **[デモを見る](demo.py)** | **[ドキュメントを読む](cc-mcp-spec.txt)**
